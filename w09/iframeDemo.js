function goPage(index){
    ...
    switch (index){
        case 1:
            p.innerHTML = `<iframe src="./w01-intro-pokemon/pokemon.html" width = "100%" heigh = "auto"></iframe>`;
            break;
        case 2:
            p.innerHTML = `<iframe src="./w02-imgal/imageGallery.html" width = "100%" heigh = "auto"></iframe>`;
            break;
        case 3:
            p.innerHTML =  `<iframe src="./w08-tku60/div_tku60.html" width = "100%" heigh = "auto"></iframe>`
    }
}
